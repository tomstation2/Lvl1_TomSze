...
public class SimpleCalculator implements ActionListener, MouseListener {
	...
	public void mousePressed(MouseEvent e) {
		...
		if (e.getSource() == addButton) {
			ans.setText(Integer.toString(calc.add(number1, number2)));
		}
		if (e.getSource() == subButton) {
			ans.setText(Integer.toString(calc.subtract(number1, number2)));
		}
		if (e.getSource() == multButton) {
			ans.setText(Integer.toString(calc.multiply(number1, number2)));
		}
		if (e.getSource() == divButton) {
			ans.setText(String.valueOf((calc.divide(number1, number2))));
		}
	}
